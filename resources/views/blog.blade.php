...
@section('content')
  ...
  <main class="container">
    ...
    <div class="row offset-md-1 mb-2 col-md-10 offset-md-1 col-sm-12 assess-section">
        <div class="col-md-6 col-sm-12 py-4 section-2-content">
        ...
        <div class="col-md-5 offset-sm-2 col-sm-12  .col-md-5 offset-md-1">
          <img src="/img/form2.png" class="form-img" alt="form picture" style="
              width: 100%;
              height: auto;
          ">
        </div>
